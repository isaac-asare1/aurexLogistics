...
class _ContactPageState extends State<ContactPage> {
  // ====== UPDATE THESE ======
  static const String whatsAppNumber = '233XXXXXXXXX'; // no + sign
  ...
  Future<void> _handleSubmit() async {
    ...
    // We’ll send the quote request via WhatsApp for now (super reliable for Ghana).
    // Later we can swap this to email, Firebase, or a backend endpoint.
